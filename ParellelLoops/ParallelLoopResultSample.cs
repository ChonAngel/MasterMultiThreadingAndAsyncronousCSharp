...
{
    public static class ParallelLoopResultSample
    {
        public static void Run()
        {
            ...
            // IsCompleted --> True=Complete, false not complete
            // LowestBreakIteration --> When IsCompleted = false
            //                          , has value --> break
            //                          , has no value --> stop, exception
